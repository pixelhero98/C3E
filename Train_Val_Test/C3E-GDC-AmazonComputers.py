...
#=================================================================================================================================================================
num_mmp_layer = [data.x.shape[1], 818, 546, 456, 407, 369, 293]
num_postpro_layer = [num_mmp_layer[-1], torch.unique(data.y).shape[0]]
num_skip_layer = num_mmp_layer[1:]
p = [0.5162398965355272, 0.4005545295720745, 0.4548592310496724, 0.4716081553428422, 0.4753476730384115, 0.44280316635049943]
